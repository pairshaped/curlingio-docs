...
If you already own a custom domain, configure your registrar to redirect it to your Curling IO subdomain (for example, `examplecurling.com` → `yourclub.curling.io`).
