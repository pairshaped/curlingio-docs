...
If you already own a custom domain, configure your registrar to redirect it to your Curling IO subdomain (for example, `your-curling-club.com` → `yourclub.curling.io`).
