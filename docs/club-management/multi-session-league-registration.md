# Multi-Session League Registration
...
## Start With Operations[​](#start-with-operations "Direct link to Start With Operations")
...
## Recommended Setup: Separate Leagues[​](#recommended-setup-separate-leagues "Direct link to Recommended Setup: Separate Leagues")
...
### Help Members Find Related Leagues[​](#help-members-find-related-leagues "Direct link to Help Members Find Related Leagues")
...
## Discounts For Playing More[​](#discounts-for-playing-more "Direct link to Discounts For Playing More")
...
## Option: One League With Paid Add-Ons[​](#option-one-league-with-paid-add-ons "Direct link to Option: One League With Paid Add-Ons")
...
## Option: One League With Custom Fields And Discounts[​](#option-one-league-with-custom-fields-and-discounts "Direct link to Option: One League With Custom Fields And Discounts")
...
## Important System Details[​](#important-system-details "Direct link to Important System Details")

These details are useful when comparing setup options or asking a chatbot for help.

### A league has one base price[​](#a-league-has-one-base-price "Direct link to A league has one base price")
...
### Add-ons are purchase items, not leagues[​](#add-ons-are-purchase-items-not-leagues "Direct link to Add-ons are purchase items, not leagues")
...
### Custom field discounts match one value[​](#custom-field-discounts-match-one-value "Direct link to Custom field discounts match one value")
...
### Discounts stack unless you prevent it[​](#discounts-stack-unless-you-prevent-it "Direct link to Discounts stack unless you prevent it")
...
### Multi-item discounts count purchases for one curler[​](#multi-item-discounts-count-purchases-for-one-curler "Direct link to Multi-item discounts count purchases for one curler")
...
### Recommendations happen before checkout[​](#recommendations-happen-before-checkout "Direct link to Recommendations happen before checkout")
...
### Reporting depends on where the choice lives[​](#reporting-depends-on-where-the-choice-lives "Direct link to Reporting depends on where the choice lives")
...
## Choosing Between The Options[​](#choosing-between-the-options "Direct link to Choosing Between The Options")
