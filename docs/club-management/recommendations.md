...
slug: /club-management/recommendations
---
...
1. When creating or editing a league, program, or product, look for the **Recommendation Keywords** field in the registration section
2. Enter keywords that describe the item, separated by commas
3. Choose keywords that reflect the type, skill level, or audience for the item

**Examples:**
- For a beginner league: `beginner, social, recreational`
- For a competitive league: `competitive, advanced, experienced`
- For a junior program: `junior, youth, kids, beginner`
- For a broom in your pro shop: `equipment, beginner, supplies`
- For a club social event: `social, fun, entertainment`
