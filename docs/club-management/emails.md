...
## Finding Emails[​](#finding-emails "Direct link to Finding Emails")

Within your admin area, click on the **Club** dropdown menu in the top bar and then click on **Emails**.

![Navigation](/assets/images/navigation-17979f36a4d042aa948aa9fe43b22212.png)
...
## Email Broadcasts[​](#email-broadcasts "Direct link to Email Broadcasts")
...
### Understanding Email Credits[​](#understanding-email-credits "Direct link to Understanding Email Credits")
...
#### How You Earn Credits[​](#how-you-earn-credits "Direct link to How You Earn Credits")
...
#### Credit Balance[​](#credit-balance "Direct link to Credit Balance")

You can view your current credit balance and usage history on the **Email Broadcasts** page.

![Email Broadcasts](/assets/images/broadcast-list-573c061da09580e19e3c15fe6b819377.png)

### Sending a Broadcast Email[​](#sending-a-broadcast-email "Direct link to Sending a Broadcast Email")
...
#### Step 1: Select Your Recipients[​](#step-1-select-your-recipients "Direct link to Step 1: Select Your Recipients")
...
#### Step 2: Compose Your Email[​](#step-2-compose-your-email "Direct link to Step 2: Compose Your Email")

![Email Composer](/assets/images/broadcast-compose-ac628be9db90c527857a3c0bd0d3c0e6.png)
...
#### Step 3: Send[​](#step-3-send "Direct link to Step 3: Send")
...
## Transactional Email Templates[​](#transactional-email-templates "Direct link to Transactional Email Templates")
...
### Customizing Transactional Email Templates[​](#customizing-transactional-email-templates "Direct link to Customizing Transactional Email Templates")
...
![Transactional Templates](/assets/images/transactional-list-3425f01450654874e806863553bcdd02.png)
...
### Resetting Templates[​](#resetting-templates "Direct link to Resetting Templates")
...
## Email Sending Best Practices[​](#email-sending-best-practices "Direct link to Email Sending Best Practices")
