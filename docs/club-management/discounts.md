...
This allows you to have different discounts apply to your leagues depending on the age and / or number of items being purchased for the curler, etc. For example you can have a junior discount based on age, or a discount that is only applied if 2 or more items (leagues, programs, fees, or products) are being purchased within the same season for the same curler.
...
### Number of Items[​](#number-of-items "Direct link to Number of Items")
...
You can even have *stepping* discounts, where for example the 2nd item is 20% off, the 3rd item is 50% off, and the 4th or higher items are 100% off (making them free).
