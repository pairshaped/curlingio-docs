...
If for example, you'd like to know the name of a team's coach during registration for one of your bonspiels, or whether it's a curler's first time curling at your club, you can create custom fields for these questions. You can even have a custom field for a coupon code and then tie a discount to it.
...
## Finding Custom Fields[​](#finding-custom-fields "Direct link to Finding Custom Fields")

Within your admin area, click on the **Club** dropdown menu in the top bar and then click on **Custom Fields**.

![Navigation](/assets/images/navigation-e28bbd3042d4d49d0a6117520b61e04f.png)

To create a custom field click on the **New custom field** button.

![New](data:image/png;base64,)
...
### The Type of Custom Field[​](#the-type-of-custom-field "Direct link to The Type of Custom Field")

You can use different types of custom fields:

#### Text Box[​](#text-box "Direct link to Text Box")

The most common field type. This is a short free form text box.

For example, *Contact Name* or *Contact Phone*.

#### Text Area[​](#text-area "Direct link to Text Area")

This is a larger free form multiline text box.

For example, *Comments* or *Notes*.

#### Dropdown[​](#dropdown "Direct link to Dropdown")

This is a dropdown field restricting a members choice to just the values you provide. Note that when selecting **Dropdown**, a **Possible Values** option will appear where you need to enter the values to populate the dropdown with.

For example, *Number of Players on the Team: Three, Four, Five, Six* or *First Time Curler?: Yes, No*.

#### Check Box[​](#check-box "Direct link to Check Box")
...
For example, *Date of Certification*.
...
### Naming your Custom Field[​](#naming-your-custom-field "Direct link to Naming your Custom Field")
...
This is a brief description that will be displayed below your custom field when members are asked to fill it in. You can include any instructions here if necessary.

### Select Relevant Reports[​](#select-relevant-reports "Direct link to Select Relevant Reports")
