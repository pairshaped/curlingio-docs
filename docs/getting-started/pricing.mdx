...
<div className="feature-comparison">
  ...
  <div className="feature-groups">
    <div className="feature-group">
      ...
      <div className="features">
        ...
        <div className="feature-row">
          <span className="feature-name">Hosted website</span>
          <span className="check essential">✓</span>
          <span className="check premium">✓</span>
        </div>
        <div className="feature-row">
          <span className="feature-name">Online payment processing<sup>1</sup></span>
          <span className="check essential">✓</span>
          <span className="check premium">✓</span>
        </div>
        <div className="feature-row">
          <span className="feature-name">Email broadcasts<sup>2</sup></span>
          <span className="check essential">✓</span>
          <span className="check premium">✓</span>
        </div>
        <div className="feature-row">
        ...
        <div className="feature-row">
          <span className="feature-name">Accrual accounting</span>
          <span className="check essential">—</span>
          <span className="check premium">✓</span>
        </div>
      </div>
    ...
    <div className="feature-group">
      ...
      <div className="features">
        <div className="feature-row">
          <span className="feature-name">League & Competition management</span>
          <span className="check essential">✓</span>
          <span className="check premium">✓</span>
        </div>
        <div className="feature-row">
  ...
  <div className="feature-footnotes">
    <p><sup>1</sup> Enabling online payment processing automatically upgrades your club to Premium tier at no additional cost.</p>
    <p><sup>2</sup> Premium clubs receive automatic email credit grants. Essential clubs can purchase credits as needed.</p>
  </div>
</div>
...
### Pricing Calculator - Annual Cost Estimate
...
**2.9% + $0.30 per online credit card transaction** plus a **$20/month fee**. Includes standard VISA and MasterCard processing fees.
