...
## Enabling or Disabling Accounting Codes[​](#enabling-or-disabling-accounting-codes "Direct link to Enabling or Disabling Accounting Codes")
...
### 1. Club-Level Defaults (Simple)[​](#1-club-level-defaults-simple "Direct link to 1. Club-Level Defaults (Simple)")
...
### 2. Item-Level Overrides (Advanced)[​](#2-item-level-overrides-advanced "Direct link to 2. Item-Level Overrides (Advanced)")
...
## The Three Code Types[​](#the-three-code-types "Direct link to The Three Code Types")

### Account Code[​](#account-code "Direct link to Account Code")
...
### Class Code (Optional)[​](#class-code-optional "Direct link to Class Code (Optional)")
...
### Project Code (Optional)[​](#project-code-optional "Direct link to Project Code (Optional)")
...
## Understanding Order Items vs Payments[​](#understanding-order-items-vs-payments "Direct link to Understanding Order Items vs Payments")
...
## How Codes Are Captured[​](#how-codes-are-captured "Direct link to How Codes Are Captured")
...
### Basic Club (Most Common)[​](#basic-club-most-common "Direct link to Basic Club (Most Common)")
...
### Intermediate Club - Demographics[​](#intermediate-club---demographics "Direct link to Intermediate Club - Demographics")
...
### Sophisticated Club - Multiple Categories[​](#sophisticated-club---multiple-categories "Direct link to Sophisticated Club - Multiple Categories")
...
## Setting Up Accounting Codes[​](#setting-up-accounting-codes "Direct link to Setting Up Accounting Codes")

### Step 1: Set Default Codes[​](#step-1-set-default-codes "Direct link to Step 1: Set Default Codes")
...
### Step 2: Add Item-Level Codes (Optional)[​](#step-2-add-item-level-codes-optional "Direct link to Step 2: Add Item-Level Codes (Optional)")
...
## Reporting and Exporting[​](#reporting-and-exporting "Direct link to Reporting and Exporting")

### Order Items Report[​](#order-items-report "Direct link to Order Items Report")
...
* Use UPPER\_CASE for consistency
...
### Plan Before You Start[​](#plan-before-you-start "Direct link to Plan Before You Start")
...
### Don't Overcomplicate[​](#dont-overcomplicate "Direct link to Don't Overcomplicate")
...
### Can I change codes after a purchase is made?[​](#can-i-change-codes-after-a-purchase-is-made "Direct link to Can I change codes after a purchase is made?")
...
### Do I need to use all three code types?[​](#do-i-need-to-use-all-three-code-types "Direct link to Do I need to use all three code types?")
...
### Can I use the same class or project code across different item types?[​](#can-i-use-the-same-class-or-project-code-across-different-item-types "Direct link to Can I use the same class or project code across different item types?")
...
### What if my accounting software doesn't support class or project tracking?[​](#what-if-my-accounting-software-doesnt-support-class-or-project-tracking "Direct link to What if my accounting software doesn't support class or project tracking?")
...
### How do I track codes for inherited fees (provincial/national)?[​](#how-do-i-track-codes-for-inherited-fees-provincialnational "Direct link to How do I track codes for inherited fees (provincial/national)?")
...
* [Programs](/docs/club-management/programs.md) - Add codes to programs
