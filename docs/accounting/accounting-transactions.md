...
### Liabilities[​](#liabilities "Direct link to Liabilities")
...
### Expenses[​](#expenses "Direct link to Expenses")
...
### 3. Refunds (Full and Partial)[​](#3-refunds-full-and-partial "Direct link to 3. Refunds (Full and Partial)")
...
### Understanding Journal Entry Grouping[​](#understanding-journal-entry-grouping "Direct link to Understanding Journal Entry Grouping")
...
### Understanding Account Labels[​](#understanding-account-labels "Direct link to Understanding Account Labels")
...
#### CSV Export (General Purpose)[​](#csv-export-general-purpose "Direct link to CSV Export (General Purpose)")
...
The group ID uses an abbreviated format: a 3-letter transaction code followed by the source ID number.

**Examples:**

* `REV12345` - Revenue recognized from order item 12345
* `PMT67890` - Payment 67890 initiated
* `DEP67890` - Payment 67890 deposited to bank
* `RFI55555` - Refund 55555 initiated
...
REV123,100,Revenue recognized,2025-01-15 10:23:45,League,Monday Night League,,MENS,1200,A/R,113.00,
REV123,100,Revenue recognized,2025-01-15 10:23:45,League,Monday Night League,,MENS,4010,Revenue,,100.00
REV123,100,Revenue recognized,2025-01-15 10:23:45,League,Monday Night League,,MENS,2110,HST,,13.00
PMT456,100,Payment initiated,2025-01-20 14:32:10,,,,,1050,Undeposited Funds,113.00,
PMT456,100,Payment initiated,2025-01-20 14:32:10,League,Monday Night League,,MENS,1200,A/R,,113.00
DEP456,100,Payment deposited,2025-01-25 00:00:01,,,,,1000,Cash,107.92,
DEP456,100,Payment deposited,2025-01-25 00:00:01,,,,,5500,Processing Fees,5.08,
DEP456,100,Payment deposited,2025-01-25 00:00:01,,,,,1050,Undeposited Funds,,113.00
```
...
#### QuickBooks Desktop IIF Export[​](#quickbooks-desktop-iif-export "Direct link to QuickBooks Desktop IIF Export")
...
#### Sage 50 Export[​](#sage-50-export "Direct link to Sage 50 Export")
...
### Step 2: Configure Account Codes[​](#step-2-configure-account-codes "Direct link to Step 2: Configure Account Codes")
...
### Plan Your Account Structure[​](#plan-your-account-structure "Direct link to Plan Your Account Structure")
...
### Reconciliation Procedures[​](#reconciliation-procedures "Direct link to Reconciliation Procedures")
...
#### 1. Reconcile Undeposited Funds to Bank Deposits[​](#1-reconcile-undeposited-funds-to-bank-deposits "Direct link to 1. Reconcile Undeposited Funds to Bank Deposits")
...
#### 2. Reconcile Accounts Receivable[​](#2-reconcile-accounts-receivable "Direct link to 2. Reconcile Accounts Receivable")
...
#### 3. Reconcile Tax Payable (HST/GST/PST)[​](#3-reconcile-tax-payable-hstgstpst "Direct link to 3. Reconcile Tax Payable (HST/GST/PST)")
...
#### 4. Reconcile Club Credit Liability[​](#4-reconcile-club-credit-liability "Direct link to 4. Reconcile Club Credit Liability")
...
#### 5. Verify Processing Fee Expenses[​](#5-verify-processing-fee-expenses "Direct link to 5. Verify Processing Fee Expenses")
...
### Monthly Reconcile Checklist[​](#monthly-reconcile-checklist "Direct link to Monthly Reconcile Checklist")
...
### What's the difference between a full refund and a partial refund?[​](#whats-the-difference-between-a-full-refund-and-a-partial-refund "Direct link to What's the difference between a full refund and a partial refund?")
...
### How do I record tax remittances to the government?[​](#how-do-i-record-tax-remittances-to-the-government "Direct link to How do I record tax remittances to the government?")
