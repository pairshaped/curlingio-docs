---
slug: why-your-curling-club-shouldnt-use-a-cms
title: "Why Your Curling Club Shouldn't Use a CMS"
authors: [dave]
tags: [club-management, security, website]
description: 'General-purpose CMS platforms like WordPress and Joomla introduce serious security risks and maintenance burden for curling clubs. Here is what you need to know.'
---
...
## Joomla and Drupal aren't immune
...
## Why this matters for curling clubs
...
### Curling IO's built-in website hosting

Every club on Curling IO can enable a [hosted website](/docs/club-management/website-hosting) at no extra cost. It's minimalist by design, so it's best suited for clubs that don't need a bunch of bells and whistles.
