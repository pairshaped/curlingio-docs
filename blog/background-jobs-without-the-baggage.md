...
## The BEAM Advantage[​](#the-beam-advantage "Direct link to The BEAM Advantage")
...
## Why Not Just Fire-and-Forget?[​](#why-not-just-fire-and-forget "Direct link to Why Not Just Fire-and-Forget?")
...
## A Separate Database[​](#a-separate-database "Direct link to A Separate Database")
...
## Enqueue Is Just an INSERT[​](#enqueue-is-just-an-insert "Direct link to Enqueue Is Just an INSERT")
...
## The Worker: An OTP Actor[​](#the-worker-an-otp-actor "Direct link to The Worker: An OTP Actor")
...
## Retry With Exponential Backoff[​](#retry-with-exponential-backoff "Direct link to Retry With Exponential Backoff")
...
## Supervised for Resilience[​](#supervised-for-resilience "Direct link to Supervised for Resilience")
...
## The Full Architecture[​](#the-full-architecture "Direct link to The Full Architecture")
...
## What We Didn't Need[​](#what-we-didnt-need "Direct link to What We Didn't Need")
