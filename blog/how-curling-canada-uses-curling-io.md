...
## Powering Canada's Biggest Curling Events[​](#powering-canadas-biggest-curling-events "Direct link to Powering Canada's Biggest Curling Events")
...
## What Curling IO Handles[​](#what-curling-io-handles "Direct link to What Curling IO Handles")
...
When fans check scores on [curling.ca/scoreboard](https://www.curling.ca/scoreboard/) during a national event, both the data and the scoreboard widgets they're looking at were built by us.
...
## The Same Platform Your Club Can Use[​](#the-same-platform-your-club-can-use "Direct link to The Same Platform Your Club Can Use")
...
You can browse Curling Canada's competitions and results at [canada.curling.io](https://canada.curling.io). Every draw schedule, scoreboard, and bracket you see there runs on Curling IO.

If your club wants the same tools that power Canadian curling at the national level, [get started here](/docs/getting-started/curling-club-managers.md). There are no setup fees or monthly fees. Check out our [pricing page](/docs/getting-started/pricing.md) for a full feature breakdown and cost calculator.
