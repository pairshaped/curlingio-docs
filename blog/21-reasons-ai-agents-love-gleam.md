...
## The Feedback Loop That Matters[​](#the-feedback-loop-that-matters "Direct link to The Feedback Loop That Matters")
...
## What the Compiler Catches[​](#what-the-compiler-catches "Direct link to What the Compiler Catches")

### No Nulls[​](#no-nulls "Direct link to No Nulls")
...
### Structural Changes[​](#structural-changes "Direct link to Structural Changes")
...
### Exhaustive Pattern Matching[​](#exhaustive-pattern-matching "Direct link to Exhaustive Pattern Matching")
...
## Simple Syntax, Fewer Ways to Go Wrong[​](#simple-syntax-fewer-ways-to-go-wrong "Direct link to Simple Syntax, Fewer Ways to Go Wrong")
...
## Whitespace Doesn't Matter[​](#whitespace-doesnt-matter "Direct link to Whitespace Doesn't Matter")
...
## Tight Feedback Loops[​](#tight-feedback-loops "Direct link to Tight Feedback Loops")

### Fast Compilation[​](#fast-compilation "Direct link to Fast Compilation")
...
### Fast Tests[​](#fast-tests "Direct link to Fast Tests")

Tests are fast too. Because each test gets its own in-memory SQLite database with no shared state, we [run them all in parallel](/blog/parallel-tests-for-free.md). Around 800 tests finish in under a second. That speed accumulates over a session where the agent is compiling and testing dozens of times.

## Less Training Data Is a Real Cost[​](#less-training-data-is-a-real-cost "Direct link to Less Training Data Is a Real Cost")
...
## The Workflow in Practice[​](#the-workflow-in-practice "Direct link to The Workflow in Practice")
...
## Other Languages[​](#other-languages "Direct link to Other Languages")
...
It also runs on the BEAM, which gives you fault tolerance and concurrency, but that's a [separate conversation](/blog/background-jobs-without-the-baggage.md).
...
## The Bet[​](#the-bet "Direct link to The Bet")
...
## Addendum: The State of AI-Assisted Coding[​](#addendum-the-state-of-ai-assisted-coding "Direct link to Addendum: The State of AI-Assisted Coding")
...
### The Bar Is Higher, Not Lower[​](#the-bar-is-higher-not-lower "Direct link to The Bar Is Higher, Not Lower")
...
### Expect More Security Vulnerabilities[​](#expect-more-security-vulnerabilities "Direct link to Expect More Security Vulnerabilities")
...
### The Industry Is Evolving[​](#the-industry-is-evolving "Direct link to The Industry Is Evolving")
...
### What Comes Next[​](#what-comes-next "Direct link to What Comes Next")
