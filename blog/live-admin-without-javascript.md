...
![Curling IO admin panel showing the product registration page](/img/blog/product-registration.png)

*The product registration page: sidebar, breadcrumbs, toggle switches, and form fields, all rendered server-side over a single WebSocket connection. Every toggle, input, and save is a live state update.*

## What's a Server Component?[​](#whats-a-server-component "Direct link to What's a Server Component?")
...
## Navigation Without Page Loads[​](#navigation-without-page-loads "Direct link to Navigation Without Page Loads")
...
## Shadow DOM and Stylesheets[​](#shadow-dom-and-stylesheets "Direct link to Shadow DOM and Stylesheets")
...
## What Runs on the Server, What Runs on the Client[​](#what-runs-on-the-server-what-runs-on-the-client "Direct link to What Runs on the Server, What Runs on the Client")
...
![The Curling IO bracket builder](/img/blog/bracket-builder.png)

*The Curling IO bracket builder. This kind of drag-and-drop interactivity needs client-side rendering.*
...
## What We Got Wrong Along the Way[​](#what-we-got-wrong-along-the-way "Direct link to What We Got Wrong Along the Way")
...
## What We Got for Free[​](#what-we-got-for-free "Direct link to What We Got for Free")
...
## Why Not SSR or a SPA?[​](#why-not-ssr-or-a-spa "Direct link to Why Not SSR or a SPA?")

### Over SSR[​](#over-ssr "Direct link to Over SSR")
...
### Over a SPA[​](#over-a-spa "Direct link to Over a SPA")
...
*This is Part 8 of the Curling IO Foundation series. Previous: [Parallel Tests for Free](/blog/parallel-tests-for-free.md).*
