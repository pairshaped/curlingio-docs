...
## Two Kinds of Text, Two Different Systems[​](#two-kinds-of-text-two-different-systems "Direct link to Two Kinds of Text, Two Different Systems")
...
## What Version 2 Taught Us[​](#what-version-2-taught-us "Direct link to What Version 2 Taught Us")
...
## Version 3: App Label Translations[​](#version-3-app-label-translations "Direct link to Version 3: App Label Translations")
...
### Catching Problems at Compile and Test Time[​](#catching-problems-at-compile-and-test-time "Direct link to Catching Problems at Compile and Test Time")
...
## Version 3: Content Translations[​](#version-3-content-translations "Direct link to Version 3: Content Translations")
...
## Language Routing[​](#language-routing "Direct link to Language Routing")
...
## Why Two Separate Systems?[​](#why-two-separate-systems "Direct link to Why Two Separate Systems?")
...
*This is part of an ongoing series documenting the technical decisions behind Curling IO Version 3. Previous post: [The Next Version of Curling IO](/blog/the-next-version-of-curling-io.md).*
