---
slug: parallel-tests-for-free
title: 'Parallel Tests for Free'
authors: [dave]
tags: [foundation, gleam, beam, testing, architecture]
---

While writing the [previous post](/blog/sqlite-test-isolation) about our per-test SQLite databases, I was describing how each test gets its own in-memory database, no shared connections, no shared state. And I thought: wait, if nothing is shared, can we just run them all at the same time?
...
## Why Sequential Was the Default
