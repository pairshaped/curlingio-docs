...
Given our goals - agent-native APIs, clean architecture, and rock-solid reliability at scale - we need a stack that can deliver:
...
This isn't about Rails being bad. It's about choosing the right foundation for what comes next. Ruby on Rails will always have a place in our hearts, but Gleam is the right tool for where we're going.

## SQLite Over PostgreSQL

**This one surprised us.**

Curling IO v2 runs on PostgreSQL. We assumed we'd use Postgres for v3. But we're betting on <a href="https://sqlite.org" target="_blank">SQLite</a> instead.
